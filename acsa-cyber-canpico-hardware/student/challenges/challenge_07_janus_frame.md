...
payload_a = bytes([0xDE, 0xAD, 0xBE, 0xEF, 0xCA, 0xFE, 0xF0, 0x0D])
# Replace these two example bytes with the pair you found in Part A.
byte_x, byte_y = 0x00, 0x01
payload_b = bytes([0xDE, 0xAD, 0xBE, 0xEF, byte_x, byte_y, 0xF0, 0x0D])
...
payload_a = bytes([0xDE, 0xAD, 0xBE, 0xEF, 0xCA, 0xFE, 0xF0, 0x0D])
# Replace these example bytes with the compatible pair found on the PC.
byte_x, byte_y = 0x00, 0x01
payload_b = bytes([0xDE, 0xAD, 0xBE, 0xEF, byte_x, byte_y, 0xF0, 0x0D])
